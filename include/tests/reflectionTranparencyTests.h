...
public:
    static void twoSpheres() {
        ...
        scene.geometries.add(Sphere(Point(0, 0, -50), 25).setEmission(Color::red()) //
    ...
    static void twoSpheresOnMirrors() {
        ...
        scene.geometries.add(Sphere(Point(-950, -900, -1000), 200).setEmission(Color(100, 20, 20)) //
                                     ->setMaterial(Material().setDiffusive(0.25).setSpecular(0.25).setShininess(20)));
        scene.geometries.add(Triangle(Point(1500, -1500, -1500), Point(-1500, 1500, -1500), Point(670, 670, 3000)) //
                                     .setEmission(Color(20, 20, 20)) //
                                     ->setMaterial(Material().setReflective(1)));
        scene.geometries.add(Triangle(Point(1500, -1500, -1500), Point(-1500, 1500, -1500),
    ...
    static void trianglesTransparentSphere() {
        ...
        scene.geometries.add(Triangle(Point(-150, -150, -115), Point(-70, 70, -140), Point(75, 75, -150)) //
                                     .setMaterial(Material().setDiffusive(0.5).setSpecular(0.5).setShininess(60))); //
        scene.geometries.add(Sphere(Point(60, 50, -50), 30).setEmission(Color::blue()) //
